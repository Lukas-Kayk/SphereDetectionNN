...
from SphereDetectionNN.src.trackers.ball_tracker_cv import BallTracker  
    ...
    try:
        while True:
            ...
            if img is not None:
                ...
                # Always show live tracking window
                cv2.imshow("Live Tracking", img)

                # Optional: enable this block to record frames
                if False:  # <- set to True to enable recording
